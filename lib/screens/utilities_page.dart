...
class UtilitiesPage extends StatelessWidget {
  static String route = 'UtilitiesPage';
  @override
  Widget build(BuildContext context) {
    ...
    return Scaffold(
                ...
                child: Row(
                  ...
                  children: [
                    Container(
                      ...
                      child: Column(
                        children: [
                          SvgPicture.asset('assets/icons/eatery.svg',
                              height: 40),
                    ...
                    Container(
                      ...
                      child: Column(
                        children: [
                          SvgPicture.asset('assets/icons/polls.svg',
                              height: 40),
                          SizedBox(height: size.height * 0.01),
                          Text(
                            'Polls',
                    ...
                    Container(
                      ...
                      child: Column(
                        children: [
                          SvgPicture.asset('assets/icons/tests.svg',
                              height: 40),
                          SizedBox(height: size.height * 0.01),
                          Text(
                            'Tests',
      ...
      bottomNavigationBar: CustomNavigationBar(
        activePage: UtilitiesPage.route,
      ),
    );
  }
}
